  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <button onClick={onBack} className="text-sm text-muted hover:text-white transition-colors cursor-pointer">&larr; 返回论文</button>
      </div>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.card}>
          <div className="font-mono text-sm text-muted leading-loose whitespace-pre">
            ...
            <br />  <span className="text-green-400">src/</span>              &lt;- <span className="text-white">你写代码的地方</span>
            ...
            <br />  <span className="text-green-400">public/</span>            &lt;- <span className="text-white">静态文件（图片等）</span>
            <br />  <span className="text-green-400">dist/</span>              &lt;- <span className="text-white">打包后的成品（自动生成）</span>
            <br />  <span className="text-green-400">package.json</span>       &lt;- <span className="text-white">项目的"说明书"</span>
            <br />  <span className="text-green-400">node_modules/</span>       &lt;- <span className="text-white">下载好的工具包（自动生成）</span>
          </div>
        </div>
      </section>
        ...
        <div className={styles.card}>
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center gap-3">
              <span className="bg-green-500/10 border border-green-500/30 text-green-300 px-4 py-2 rounded-lg text-sm font-mono">npm run dev</span>
              <span className="bg-green-500/10 border border-green-500/30 text-green-300 px-4 py-2 rounded-lg text-sm font-mono">npm run build</span>
              <span className="bg-green-500/10 border border-green-500/30 text-green-300 px-4 py-2 rounded-lg text-sm font-mono">npm install</span>
            </div>
            ...
            <div className="flex justify-center gap-3">
              <span className="bg-surface border border-border text-white px-4 py-2 rounded-lg text-sm font-mono">index.html</span>
              <span className="bg-surface border border-border text-white px-4 py-2 rounded-lg text-sm font-mono">index.js</span>
              <span className="bg-surface border border-border text-white px-4 py-2 rounded-lg text-sm font-mono">index.css</span>
            </div>
